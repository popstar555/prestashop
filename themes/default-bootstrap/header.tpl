...
{if isset($css_files)}
	...
	{/foreach}
	<link rel="stylesheet" href="{'/themes/default-bootstrap/css/font-awesome/font-awesome.css'|escape:'html':'UTF-8'}" type="text/css" media="{$media|escape:'html':'UTF-8'}" />
{/if}
			...
			<div class="header-container">
				<header id="header">
					<div>
						<div class="container">
							<div class="row">
								<div class="col-12" style="height: 30px; background-color: #fbb122;">
								</div>
								<div class="col-md-12">
									<a href="{if $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}" title="{$shop_name|escape:'html':'UTF-8'}">
										<img class="logo img-responsive" src="{$logo_url}" alt="{$shop_name|escape:'html':'UTF-8'}" width="100%" height="100%" />
									</a>
								</div>
								<div class="col-md-12">
									<!-- Logo -->
									...
									<div class="row">
										<div class="col-md-12 social">
											{* <span class="text">{l s='Segueix-nos'}</span><br /> *}
											<span class="icons" style="position: absolute; right: 41px; top: -124px;">
												<a href="https://www.facebook.com/casa.delave?fref=ts" class="facebook" target="_blank"><i class="fa fa-facebook-square"></i></a>
											</span>
										</div>
									</div>
								</div>
							</div>
							<div class="row navigation_top">
								<!-- Navigation -->
								<div class="col-md-12">
